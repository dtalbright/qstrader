...
class TearsheetStatistics(Statistics):
    ...
    def _plot_drawdown(self, stats, ax=None, prepend_title=None, **kwargs):
        """
    ...
    def plot_results(self, filename=None):
        ...
        ax_bench_drawdown = plt.subplot(gs[3, :])
        ax_txt_curve = plt.subplot(gs[4, 0])
        ax_yearly_returns = plt.subplot(gs[4, 1:])
        #ax_monthly_returns = plt.subplot(gs[5, :])
        ...
        self._plot_drawdown(bench_stats, ax=ax_bench_drawdown, prepend_title="Benchmark")
        ...
        fig.suptitle(self.title, y=0.94, weight='bold')
        self._plot_monthly_returns(stats)
